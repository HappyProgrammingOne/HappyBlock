const LibraryCreator = {
	start: (blocksJSON, category, text) => {
		...
		if (Entry.getMainWS()) {
			...
			// 아이콘 적용
			$('head').append(`<style>#entryCategory${category}{background-image:url(C:/Users/user/Desktop/Visual Studio Code/Entry/Happy block/images/icon.svg);background-repeat:no-repeat;margin-bottom:1px;background-position-y: 10px;background-size: 20px;}.entrySelectedCategory#entryCategory${category}{background-image:url(C:/Users/user/Desktop/Visual Studio Code/Entry/Happy block/images/icon_selected.svg);background-color:#F4DF87;border-color:##F4DF87;color:#fff}</style>`);
			// 카테고리 이름 적용;
...
// HappyBlockLoad();
console.clear();
console.log('%cHappy Block 1.0.0%c\n\n해프밍(happyprogramming)의 해피 블럭을 사용해주셔서 감사합니다.\n이 블럭은 62045님의 특급 블럭을 사용하여 제작하였습니다.\nhttps://github.com/entry62045/HappyBlock\n\n%c엔트리 : https://playentry.org/entry62045\nGitHub : https://github.com/entry62045\n특급 블럭 : https://github.com/entry62045/HappyBlock', 'font-family: 맑은 고딕; color: #ffffff; background-color: #66AA33; border-radius: 20px; font-size: 26px; padding : 20px 30px', 'color: #000000; background-color: #FFFFFF; font-size: 17px;', 'color: #000000; background-color: #FFFFFF; font-size: 15px;');